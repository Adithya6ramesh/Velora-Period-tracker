        ...
        >
          <motion.path
            ...
            animate={{
              d: [
                ...
                "M0,80 C150,60 350,120 600,80 C850,40 1050,100 1200,80 L1200,120 L0,120 Z",
                "M0,60 C150,100 350,0 600,60 C850,120 1050,20 1200,60 L1200,120 L0,120 Z"
              ]
            }}
            transition={{
          ...
          <defs>
            <linearGradient id="waveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="50%" stopColor="rgba(233, 213, 255, 0.2)" />
              <stop offset="100%" stopColor="rgba(254, 202, 202, 0.3)" />
            </linearGradient>
          </defs>
        </svg>
      </div>
