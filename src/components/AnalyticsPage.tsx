    ...
    <div className="min-h-screen p-6 relative z-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-light text-gray-700 font-amaze">Statistical Analysis</h1>
        </motion.div>
          ...
          >
            <Card className="p-6 bg-white/90 backdrop-blur-md border border-pink-100/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-700 font-amaze">Average Cycle</h3>
              </div>
              <motion.div
                initial={{ scale: 0.8, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ delay: 0.3 }}
                className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent font-amaze"
              >
                28 days
              </motion.div>
            </Card>
          ...
          >
            <Card className="p-6 bg-white/90 backdrop-blur-md border border-purple-100/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-700 font-amaze">Cycle Regularity</h3>
              </div>
              <motion.div
                initial={{ scale: 0.8, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ delay: 0.5 }}
                className="text-2xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent font-amaze"
              >
                Regular
              </motion.div>
            </Card>
          ...
          >
            <Card className="p-6 bg-white/90 backdrop-blur-md border border-green-100/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-medium text-gray-700 font-amaze">Current Trend</h3>
              </div>
              <motion.div
                initial={{ scale: 0.8, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ delay: 0.7 }}
                className="text-sm text-gray-600 font-amaze"
              >
        ...
        >
          <Card className="p-6 bg-white/90 backdrop-blur-md border border-pink-100/50 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-xl font-medium text-gray-700 mb-6 font-amaze">Cycle Length Variation</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={cycleData}>
                  <XAxis 
                    ...
                    axisLine={false} 
                    tickLine={false} 
                    className="text-sm text-gray-500 font-amaze"
                  />
                  <YAxis 
                    domain={[25, 35]} 
                    axisLine={false} 
            ...
            <div className="flex items-center gap-4 mt-4 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span className="font-amaze">Cycle Length</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-0.5 bg-gray-300"></div>
                <span className="font-amaze">Avg</span>
              </div>
            </div>
          </Card>
        </motion.div>
